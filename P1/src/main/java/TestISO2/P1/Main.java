...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (edad < 0 || edad > 120) {
			...
			try {
				...
				// Limpiar el escaner para que no haga un bucle continuo de excepci�n.
				escaner.nextLine();
	...
	public static void obtenercuenta (Cliente c1) {
		...
		} else if (c1.getEdad() < 25 && c1.getEdad() >= 18) {

			if (c1.isEstudiante() && c1.isIndependiente())
				System.out.println("La cuenta ideal para este cliente es la 'Cuenta Vamos que t� puedes'");
